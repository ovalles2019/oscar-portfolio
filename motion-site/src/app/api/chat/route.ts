...
Notable projects with live demos: EvalForge (evalforge-235p.onrender.com) — multi-dimensional LLM eval harness with CI gate, RadiTriage (raditriage.onrender.com), Agentic AI Governance Harness (agentic-governance-demo.onrender.com), Nexus SRE Cloud Cost & Reliability Agent (cloud-sre-agent.onrender.com), FieldTech Assistant, Budget Insights, pgvector RAG Demo (pgvector-rag-demo.onrender.com), Small Business Operations MCP, ML Experiment Tracker MCP, AWS CloudOps MCP — see portfolio project cards for URLs.
