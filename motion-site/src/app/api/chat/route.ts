...
Notable projects with live demos: SentinelCV (sentinelcv-api.onrender.com) — live CV operator console with AWS Rekognition, multi-feed health, and TxDOT Dallas corridor speeds; EvalForge (evalforge-235p.onrender.com) — multi-dimensional LLM eval harness with CI gate; RadiTriage (raditriage.onrender.com); Agentic AI Governance Harness (agentic-governance-demo.onrender.com); Nexus SRE Cloud Cost & Reliability Agent (cloud-sre-agent.onrender.com); FieldTech Assistant; Budget Insights; pgvector RAG Demo (pgvector-rag-demo.onrender.com); Small Business Operations MCP; ML Experiment Tracker MCP; AWS CloudOps MCP; AI Competitor News Weekly Digest (n8n automation + homepage #weekly-digest subscribe) — see portfolio project cards for URLs.
