...
const ScrollExpandMedia = ({
  ...
  const mediaHeight = 460 + scrollProgress * (isMobileState ? 160 : 340);
            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                {mediaType === 'video' ? (
                  ...
                  >
                    <div
                      className='pointer-events-none absolute inset-0 rounded-xl bg-black/15 ring-1 ring-inset ring-white/12 backdrop-blur-2xl [box-shadow:inset_0_1px_0_rgba(255,255,255,0.05)]'
                      aria-hidden
                    />
                    <Image
                      src={mediaSrc}
